 ...
 * BCM_MainFunction.c
 *
 * Created: 30-Aug-21 9:47:11 PM
 *  Author: ayman
 */ 
#include "BCM_MainFunction.h"
...
#define TIMER_TIMEOUT										(uint8_t)(2000)
...
#define STATE_DATA_SENDING_COMPLETE								(10)
...
E_STATUS BCM_RxMainFunction()
{
	...
	if ((PACKET_COMMAND == gu8_Received) || (PACKET_DATA == gu8_Received))
	{
