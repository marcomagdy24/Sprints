...
/*---------------------------- LCD STATES ---------------------------*/
#define STATE_LCD_PIN_INITIALIZATIED			(1)
#define STATE_FIRST_COMMAND						(3)
#define STATE_SECOND_COMMAND					(4)
#define STATE_THIRD_COMMAND						(5)
/******************************************************************************
...
uint8_t u8_retval = OPERATION_STARTED;
uint32_t u8_TimerRetval = OPERATION_STARTED;
uint8_t au8_status = OPERATION_STARTED;
/******************************************************************************
