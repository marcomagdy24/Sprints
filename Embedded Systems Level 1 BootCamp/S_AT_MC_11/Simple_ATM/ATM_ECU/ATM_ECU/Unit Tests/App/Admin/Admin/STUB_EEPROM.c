...
EEPROM_ERROR_state_t EEPROM_Read(uint8_t EEPROM_CH, uint8_t memoryBlock, uint8_t start_address, uint8_t* data)
{
	data[start_address] = gau8_Memory[start_address];
	return E_EEPROM_SUCCESS;
}

EEPROM_ERROR_state_t EEPROM_Write(uint8_t EEPROM_CH, uint8_t memoryBlock, uint8_t start_address, uint8_t* data)
{
	gau8_Memory[start_address] = data;
	return E_EEPROM_SUCCESS;
}
